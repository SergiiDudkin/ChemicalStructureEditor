...
import {
	setAttrsSvg, attachSvg, DeletableAbortable, CtrRect, CtrCircle, CtrPolygon, excludeNonExisting} from './Utils.js';
import {
	vecLen, findDist, unitVec, vecSum, vecDif, vecMul, vecDotProd, rotateVec, rotateAroundCtr, scaleAroundCtr,
	stretchAlongDir, polygonAngle, polygonEdgeCtrDist, polygonVertexCtrDist, MOVE, ROTATE, SCALE, STRETCH
} from './Geometry.js';
